  ...
  <div id="mySidebar" class="sidebar">
      ...
      <a href="/final-version/main-page/userProfile.php"><img name="My Profily" class="profile-icon" src="/images/477_profile__avatar__man_-512.webp" alt="profile-icon"></a>
      <a href="/final-version/main-page/About.php">About</a>
      <a href="/final-version/Main-page/LastDesignMain.php">Home</a>
      <a href="/final-version/Main-page/socialMedia.php">Social Media</a>
      <a href="#">Contact Us</a>
  </div>
  <div id="main">
  ...
  <form id="login" class="popUp" action="login.php" method="POST">
      ...
      <?php if (isset($_GET['error'])) {
            ...
            if ($_GET['error'] == 'wrongpass') {
                echo "<br><p class='errormsg' >Wrong Passowrd</p> ";
            } else  if ($_GET['error'] == 'emaildoesntexist') {
                echo "<br><p class='errormsg' >Account dosn't exist</p> ";
            }
        }
        ?>
  </form>
