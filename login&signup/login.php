    ...
    if (empty($email) || empty($pass)) {
        ...
        if (!mysqli_stmt_prepare($stmt, $sql)) {
            ...
            if ($row = mysqli_fetch_assoc($result)) {
                ...
                if ($passcheck == false) {
                    header("Location: /final-version/Main-page/LastDesignMain.php?error=wrongpass");
                    exit();
                ...
                header("Location: /final-version/Main-page/LastDesignMain.php?error=emaildoesntexist");
